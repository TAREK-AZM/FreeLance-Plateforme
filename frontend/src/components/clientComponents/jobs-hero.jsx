...
export default function Hero({ activeCategory, setActiveCategory, searchQuery, setSearchQuery }) {
  return (
    <div className="px-12 py:10 lg:py-24 md:px-6 lg:px-8">
      <h1 className="text-4xl md:text-5xl font-bold text-[#12AE65] ml-12 mb-2">Get hired!
      </h1>
      <p className="text-xl text-gray-900 md:ml-12 mb-8">We have 252 + Jobs from all over the world</p>
