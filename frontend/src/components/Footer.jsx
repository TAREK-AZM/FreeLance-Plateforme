...
//     <footer className="bg-stone-800/90 backdrop-blur-md text-stone-200 py-8">
...
function Footer() {
  return (
      <footer className="bg-gradient-to-r from-cyan-950 to-cyan-900 backdrop-blur-lg text-gray-100 py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">Quick Links</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4">Follow Us</h3>
              <div className="flex space-x-4">
                <Button variant="ghost" size="icon" className="hover:text-gray-300 transition-colors">
                  <Facebook className="h-5 w-5" />
                  <span className="sr-only">Facebook</span>
                </Button>
                <Button variant="ghost" size="icon" className="hover:text-gray-300 transition-colors">
          ...
          <div className="mt-8 pt-8 border-t border-cyan-800 text-center">
            <p>© 2024 FreeLance. All rights reserved.</p>
          </div>
        </div>
      </footer>
