...
function DashboardCard({ title, value, icon: Icon, className }) {
  return (
    <Card className={`bg-white border border-[#E0E0E0] shadow-sm hover:shadow-lg transition-all duration-200 ease-in-out hover:scale-105 hover:brightness-105 ${className}`}>
