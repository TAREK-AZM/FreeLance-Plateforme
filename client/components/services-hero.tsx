...
export default function Hero({ activeCategory, setActiveCategory, searchQuery, setSearchQuery }: HeroProps) {
  return (
    <div className="px-12 py-8 md:px-6 lg:px-8">
      <h1 className="text-4xl md:text-5xl font-bold text-[#12AE65] ml-12 mb-2">Find Services</h1>
      <p className="text-xl text-gray-900 ml-12 mb-8">We have 31 + Services From All Over World</p>
